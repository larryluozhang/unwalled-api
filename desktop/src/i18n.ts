...
const STRINGS: Record<NativeLocale, Strings> = {
  en: {
    tooltip: 'Unwalled API — local LLM router',
  ...
  'zh-CN': {
    tooltip: 'Unwalled API — 本地 LLM 路由器',
    runningOn: '运行于 {addr}',
    openDashboard: '打开仪表板',
  ...
  fr: {
    tooltip: 'Unwalled API — routeur LLM local',
  ...
  es: {
    tooltip: 'Unwalled API — enrutador LLM local',
  ...
  'pt-BR': {
    tooltip: 'Unwalled API — roteador LLM local',
  ...
  it: {
    tooltip: 'Unwalled API — router LLM locale',
